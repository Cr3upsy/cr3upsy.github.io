...
Plusieurs daemons de notifcation peuvent être utilisé pour la gestion des notification. L'un des plus connus et des utilisés sous i3 est Dunst. Il est léger et plutot simple à configurer. 
...
On note plusieurs chemin où se trouve l'icone. Nous ajoutons ces chemins dans notre fichier `dunstrc` à la suite des autres chemins dans la variable `icon_path`, et reitirer les étapes au dessus afin de valider qu'aucune erreur n'est générée par `dunst`.
